...
- **Low Interaction Honeypots**: Simulates common services.
- **Intrusion Logging**: Captures connection attempts, payloads, and attacker IP addresses.
- **Behaviour Analysis**: Analyzes the captured data to identify attack patterns, techniques, and signatures.
